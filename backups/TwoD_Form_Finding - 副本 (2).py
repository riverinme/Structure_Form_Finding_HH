...
class TwoDShapeFinding():
    def __init__(self, m, n,
        ...
        self.__links = links  # store sub list of points next to a point
        ...
        self.__linked_frames = []  # store sub list of frames next to a point
    ...
    def set_force_density(self, init_rou, *args):
        if not self.frame_names:
            ...
            return -1
        self.frame_force_density = [init_rou for a in self.frame_names]
        for nm, rou in args:
            self.frame_force_density[self.frame_names.index(nm)] = rou
        print(self.frame_force_density)
    ...
    def force_density(self, rou, ret_type="t",
        ...
        if SAP2000:
            ...
            pre_temp = [-rou*i/(Young*sec_area*thermal) for i in lengths]
            # baking pre_temp
...
if __name__ == "__main__":
    ...
    ll1 = ccc.force_density(-1, "g", False,  1e-4,
                            "China", "JTG", "JTGD62 fpk1470", 0.06)
    ...
    # aaa.force_density(10000, "g", False, 1e-4,
    #                   "China", "JTG", "JTGD62 fpk1470", 0.06)
